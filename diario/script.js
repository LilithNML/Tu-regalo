...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const chapters = [
    ...
    <p>Siempre tuya,</p>
    <p>Tu <span class="highlight">Princesa</span>.</p>
</div>
    ...
    <p>A veces, cuando te extraño, miro el peluche de <span class="highlight">Mariachi</span> que me regalaste, ese pingüino tan especial que es un pedacito de ti conmigo. Me recuerda a nuestras conversaciones, a tus ocurrencias y a la forma en que siempre logras sacarme una sonrisa. Hay tantos momentos que quiero compartir contigo, tantas risas que quiero provocar. Pienso en ti y en la profundidad de tus sentimientos, y siento en el alma que <span class="highlight">Soy tuya</span>, completamente tuya, en cada pensamiento y en cada latido. Esta distancia solo hace que mi deseo de estar contigo sea más fuerte, más inquebrantable.</p>
    ...
    <p>Hay días en los que siento una añoranza profunda, de esas que duelen en el pecho. Esos días, solo quiero escuchar tu voz, saber que estás bien, que sigues siendo esa persona maravillosa que <span class="highlight">Nunca cambies</span>. Te juro que cada vez que no hablamos, <span class="highlight">Te extraño</span> de una manera que no puedo describir. Es como si faltara una melodía en mi día, un color en mi paisaje. Pero luego pienso en todas las cosas que nos gusta hacer juntos, como ver <span class="highlight">Steven Universe</span>, y una sonrisa se dibuja en mi rostro. Me encanta imaginarte a mi lado, riendo con cada episodio, comentando las escenas, compartiendo ese momento tan nuestro.</p>
    ...
    },
    {
      ...
      content: `
        <div style="text-align: justify;">
    <p>Mi amor,</p>
    <p>Hay un anhelo que me acompaña cada día, una imagen que se repite en mi mente como una hermosa melodía: el momento en que te tenga cerca y pueda <span class="highlight">kiss me</span>. Es un deseo tan profundo, tan latente, que a veces siento que puedo casi saborearlo. Me imagino la dulzura de ese instante, la forma en que nuestros labios se encontrarán después de tanto tiempo. Cada vez que miro mi personaje favorito, <span class="highlight">Raiden</span>, en Genshin, pienso en ti y en tu <span class="highlight">Furina</span>, y en cómo incluso en el juego, nuestros gustos se complementan. Esos pequeños detalles, esas conexiones invisibles, son las que me hacen sentir que estamos destinados.</p>
    <p>Me encanta escucharte hablar, me encanta tu risa, me encanta la forma en que tus ojos se achinan cuando sonríes. Simplemente, <span class="highlight">Me encantas</span>, en cada faceta de tu ser, en cada imperfección que para mí es pura perfección. Anoche hablé con mi amiga <span class="highlight">Johanna</span>, y le conté lo emocionada que estoy por nuestro futuro, por todo lo que construiremos juntos. Ella, al igual que yo, sabe que eres el hombre de mi vida. Me da tanta paz pensar en ti, en tu calidez, en esa forma tan tuya de hacerme sentir segura y amada. Sé que el día de nuestro encuentro está cada vez más cerca, y esa certeza es el motor que impulsa cada uno de mis días.</p>
    <p>Con el corazón lleno de ti,</p>
    <p>Tu <span class="highlight">Princesa</span>.</p>
</div>
        <img src="" alt="">
    ...
    },
    {
      ...
      content: `
        <div style="text-align: justify;">
    <p>Mi amor,</p>
    <p>Hoy, mientras escuchaba <span class="highlight">Alguien como tú</span>, la canción que me recomendaste, no pude evitar sonreír. Cada nota me trajo un recuerdo tuyo, de tu voz, de tu sonrisa. Es curioso cómo una simple melodía puede transportarme directamente a tu lado, sin importar los kilómetros que nos separen. A veces, cuando hablamos, me dices <span class="highlight">Tsukasa</span>, y me encanta ese apodo. Me hace sentir que tenemos nuestro propio universo, lleno de códigos y de referencias que solo nosotros entendemos. Pienso en nuestras aventuras en <span class="highlight">Genshin</span>, en esas misiones que compartimos y en cómo, gracias a ti, por fin gané el 50/50 en el <span class="highlight">Gachapon</span>. Eres mi amuleto de la buena suerte, mi talismán.</p>
    ...
    <p>A veces, cuando te miro a los ojos en una videollamada, siento que mi corazón explota de felicidad. Estoy tan profundamente <span class="highlight">enamorada</span> de ti, que cada día a tu lado, incluso a la distancia, es un regalo. Eres mi razón de ser, mi inspiración. Y sé que, aunque el camino no siempre sea fácil, <span class="highlight">nada nos va a separar</span>. Esta es una promesa que llevo grabada en el alma. Nuestro amor es una fuerza imparable, y estoy segura de que muy pronto, esa distancia que hoy nos separa se convertirá en un hermoso recuerdo de lo fuertes que somos juntos. Eres mi <span class="highlight">sol</span> y yo tu <span class="highlight">luna</span>, siempre girando uno alrededor del otro, en perfecta armonía.</p>
    ...
    <p>Me gusta imaginarte escuchando a <span class="highlight">Hatsune Miku</span>, esa artista que tanto te gusta, y ver la alegría en tus ojos. Son esas pequeñas cosas que te hacen tan especial para mí. Y sí, a veces, cuando te digo <span class="highlight">mami</span>, es mi forma de bromear, de recordarte que te consiento, que eres mi <span class="highlight">mi niño consentido</span>. Pero hay una verdad profunda en ello, un deseo de cuidarte y protegerte siempre. Pienso en nuestros momentos más íntimos, en la forma en que anhelo el día en que pueda sentirte completamente mío, en que pueda ser tuya en cada sentido de la palabra, y quiero que me hagas <span class="highlight">sexo</span>. Es un deseo que me quema por dentro, una promesa de lo que nos espera. Sé que ese día llegará, y será tan mágico como lo he soñado.</p>
    ...
    <p>Me gusta jugar contigo, incluso si a veces hay personajes como <span class="highlight">Paimon</span> que nos sacan de quicio. O cuando en <span class="highlight">Brawl</span> me hablas de tu estrategia para usar a <span class="highlight">Colette</span>. Esos momentos de diversión compartida son tesoros para mí. Y no puedo evitar pensar en el cariño con el que te refieres a tu mejor amiga, <span class="highlight">Johanna</span>, o en tu personaje favorito de Kimetsu no Yaiba, <span class="highlight">Himikotoga</span>. Son piezas de tu mundo que me dejas conocer, y cada una de ellas me hace amarte más. Y sí, a veces solo quiero decirte <span class="highlight">:)</span>, porque con una simple carita feliz tuya, mi mundo se ilumina. Eres mi calma, mi alegría, la persona con la que quiero compartir cada segundo de mi vida.</p>
    ...
    <p>Y sí, a veces, cuando algo no me parece, solo te pongo <span class="highlight">...</span>, y tú, con esa intuición tan tuya, sabes exactamente lo que quiero decir. Es una comunicación que va más allá de las palabras, una conexión de almas que solo nosotros entendemos. Pienso en todas las veces que te he dicho que <span class="highlight">me gustas mucho</span>, que estoy completamente <span class="highlight">enamorada</span> de ti. No hay duda en mi corazón, mi amor, que eres la persona con la que quiero pasar el resto de mi vida. Eres mi refugio, mi alegría, la persona que me hace sentir más viva que nunca. Cada día a tu lado, aunque sea a distancia, me hace sentir que <span class="highlight">soy la mujer mas feliz del mundo</span>.</p>
    <p>Siempre tuya, y con el corazón en cada palabra,</p>
    <p>Tu <span class="highlight">Luna</span>.</p>
</div>
        <img src="" alt="">
